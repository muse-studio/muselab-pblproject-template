...
% 本文．
% ==========================================
\input{32045036_SasakiMio}  % 本文は muselab-sample.tex に書く
...
\bibliography{bunken} % .bibファイルの名前（Zoteroからエクスポートして作る）
...
\input{32045036_SasakiMio-append} % 付録は appendix-sample.tex に書く
