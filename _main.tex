...
%\newcommand{\Imazato}{\char"2F75F 里}
%\newcommand{\Imazato}{今里} %本来の漢字はどうがんばってもコンパイルエラーになるようなので，代用漢字を使うことにした．
% ------------------------------------------
...
\title{\input{author-title}} % 卒業論文のタイトルを書く
...
\author{\input{author-name0}{\input{author-name-eng}}{FUKU}[]
