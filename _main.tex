...
\renewcommand{\revicedate}{\japanesedate\today} % 審査会後の最終提出日
% ------------------------------------------
...
% 本文．
% ==========================================
\input{kin-main}  % 本文は muselab-sample.tex に書く
...
\bibliography{ronbun} % .bibファイルの名前（Zoteroからエクスポートして作る）
...
\input{kin-appendix} % 付録は appendix-sample.tex に書く
