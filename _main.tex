...
\title{京都府の魅力を写真と音で伝えるサウンドマップの開発}
...
\author{32145054　高橋　永遠}{TAKAHASHI Towa}{FUKU}[]
...
% 本文．
% ==========================================
\input{takahashi-0121}  % 本文は muselab-sample.tex に書く
...
\bibliography{takahashi2025} % .bibファイルの名前（Zoteroからエクスポートして作る）
