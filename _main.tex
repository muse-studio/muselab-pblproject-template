...
\author{32045016　小形幹}{OGATA Kan}{FUKU}[]
...
% 本文．
% ==========================================
\input{ogata-0120}  % 本文は muselab-sample.tex に書く
...
\bibliography{ogata2025} % .bibファイルの名前（Zoteroからエクスポートして作る）
